...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester() {
        ...
        User tester = userLoggedInService.getLoggedInUser();//getting the current logged in user
        return testRequestQueryService.findByTester(tester);//returns the list of test requests assigned to current tester
    }
